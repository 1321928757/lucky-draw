...
-- ----------------------------
INSERT INTO `raffle_activity_sku` VALUES (1, 9011, 100301, 11101, 20, 0, '2024-03-16 11:41:09', '2024-03-30 17:10:07');
...
-- ----------------------------
INSERT INTO `rule_tree_node` VALUES (1, 'tree_lock_1', 'rule_lock', '限定用户已完成N次抽奖后解锁', '20', '2024-01-27 10:03:09', '2024-04-16 19:10:03');
...
INSERT INTO `rule_tree_node` VALUES (6, 'tree_lock_2', 'rule_lock', '限定用户已完成N次抽奖后解锁', '30', '2024-01-27 10:03:09', '2024-04-16 19:10:05');
...
INSERT INTO `strategy_award` VALUES (22, 100006, 101, '随机积分', NULL, 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 37, 0.0200, 'tree_luck_award', 1, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
INSERT INTO `strategy_award` VALUES (23, 100006, 102, '7等奖', NULL, 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 0, 0.0300, 'tree_luck_award', 2, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
INSERT INTO `strategy_award` VALUES (24, 100006, 103, '6等奖', NULL, 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 10, 0.0300, 'tree_luck_award', 3, '2023-12-09 09:38:31', '2024-04-28 21:28:50');
INSERT INTO `strategy_award` VALUES (25, 100006, 104, '5等奖', NULL, 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 11, 0.0300, 'tree_luck_award', 4, '2023-12-09 09:38:31', '2024-04-28 20:23:05');
INSERT INTO `strategy_award` VALUES (26, 100006, 105, '4等奖', NULL, 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 0, 0.0300, 'tree_luck_award', 5, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
INSERT INTO `strategy_award` VALUES (27, 100006, 106, '3等奖', '抽奖20次后解锁', 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 10, 0.0300, 'tree_lock_1', 6, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
INSERT INTO `strategy_award` VALUES (28, 100006, 107, '2等奖', '抽奖20次后解锁', 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 14, 0.0300, 'tree_lock_1', 7, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
INSERT INTO `strategy_award` VALUES (29, 100006, 108, '1等奖', '抽奖30次后解锁', 'https://luckysj-1314434715.cos.ap-shanghai.myqcloud.com/fb0e4655-c58a-47cb-b282-ab07fd089db3.png', 100, 15, 0.0300, 'tree_lock_2', 8, '2023-12-09 09:38:31', '2024-04-28 20:21:16');
...
CREATE TABLE `strategy_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_strategy_id_award_id`(`strategy_id` ASC, `award_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖策略规则' ROW_FORMAT = Dynamic;
